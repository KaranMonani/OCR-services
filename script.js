...
document.getElementById("capture-button").onclick = function () {
    ...
    document.getElementById("uploaded-image").src = ""; // Clear previous uploaded image
...
document.getElementById("final-upload-button").addEventListener("click", () => {
    ...
    // After processing, hide the loading icon and show the button text
    setTimeout(() => {
        document.getElementById("loading-icon").style.display = "none";
        document.getElementById("button-text").style.display = "block";
        // Show skeleton effect after processing
        document.querySelectorAll(".skeleton").forEach(skeleton => {
            skeleton.style.display = "block";
        });
    }, 6000); // Replace with your actual processing time
});
